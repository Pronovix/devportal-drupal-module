#!/usr/bin/env bash
# Based on https://github.com/apigee/apigee-edge-drupal/blob/8.x-1.0/.travis/push-logs.sh.
...
git remote add origin https://${LOGS_REPO_USER}:${LOGS_REPO_PASSWORD}@${LOGS_REPO_HOST}/${LOGS_REPO_OWNER:-${LOGS_REPO_USER}}/${LOGS_REPO_NAME}.git
