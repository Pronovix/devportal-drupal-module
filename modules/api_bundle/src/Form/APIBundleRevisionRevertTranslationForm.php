...
/**
 * Provides a form for reverting an APIBundle revision for a single translation.
 *
 * @ingroup devportal_api_bundle
 */
class APIBundleRevisionRevertTranslationForm extends APIBundleRevisionRevertForm {
  ...
  /**
   * Constructs a new APIBundleRevisionRevertTranslationForm.
   *
  ...
  public function getFormId() {
    return 'api_bundle_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $api_bundle_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $api_bundle_revision);
  ...
  protected function prepareRevertedRevision(APIBundleInterface $revision, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\devportal_api_bundle\APIBundleInterface $latest_revision */
    $latest_revision = $this->apiBundleStorage->load($revision->id());
