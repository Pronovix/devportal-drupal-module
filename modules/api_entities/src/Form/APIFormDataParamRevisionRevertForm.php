...
class APIFormDataParamRevisionRevertForm extends ConfirmFormBase {
   ...
   *
   * @var \Drupal\devportal_api_entities\APIFormDataParamInterface
   */
  protected $revision;
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->messenger()->addMessage($this->t('API HTTP Method Form Data Parameter %title has been reverted to the revision from %revision-date.', [
      '%title' => $this->revision->label(),
   ...
   *
   * @param \Drupal\devportal_api_entities\APIFormDataParamInterface $revision
   *   The revision to be reverted.
   * @param \Drupal\Core\Form\FormStateInterface $form_state
   *   The current state of the form.
   *
   * @return \Drupal\devportal_api_entities\APIFormDataParamInterface
