...
class APIGlobalResponseRevisionRevertForm extends ConfirmFormBase {
   ...
   *
   * @var \Drupal\devportal_api_entities\APIGlobalResponseInterface
   */
  protected $revision;
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->messenger()->addMessage($this->t('API Global Response %title has been reverted to the revision from %revision-date.', [
      '%title' => $this->revision->label(),
   ...
   *
   * @param \Drupal\devportal_api_entities\APIGlobalResponseInterface $revision
