...
class APIResponseRevisionRevertForm extends ConfirmFormBase {
   ...
   *
   * @var \Drupal\devportal_api_entities\APIResponseInterface
   */
  protected $revision;
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->messenger()->addMessage($this->t('API Response %title has been reverted to the revision from %revision-date.', [
      '%title' => $this->revision->label(),
   ...
   *
   * @param \Drupal\devportal_api_entities\APIResponseInterface $revision
