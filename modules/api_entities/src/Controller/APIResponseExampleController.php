...
use Drupal\devportal_api_entities\APIResponseExampleStorageInterface;
...
class APIResponseExampleController extends ControllerBase {
  ...
  public function revisionPageTitle($api_response_example_revision) {
    /** @var \Drupal\devportal_api_entities\Entity\APIResponseExample $api_response_example */
    $api_response_example = $this->entityTypeManager()->getStorage('api_response_example')->loadRevision($api_response_example_revision);
   ...
   *
   * @param \Drupal\devportal_api_entities\APIResponseExampleInterface $api_response_example
  ...
  public function revisionOverview(APIResponseExampleInterface $api_response_example) {
    ...
    /** @var \Drupal\devportal_api_entities\APIResponseExampleStorageInterface $api_response_example_storage */
    ...
    foreach ($this->getRevisionIds($api_response_example, $api_response_example_storage) as $vid) {
      /** @var \Drupal\devportal_api_entities\APIResponseExampleInterface $revision */
   ...
   * @param \Drupal\devportal_api_entities\APIResponseExampleStorageInterface $api_response_example_storage
