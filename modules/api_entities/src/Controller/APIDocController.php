...
use Drupal\devportal_api_entities\APIDocStorageInterface;
...
class APIDocController extends ControllerBase {
  ...
  public function revisionOverview(APIDocInterface $api_doc) {
    ...
    /** @var \Drupal\devportal_api_entities\APIDocStorageInterface $api_doc_storage */
    ...
    foreach ($this->getRevisionIds($api_doc, $api_doc_storage) as $vid) {
      /** @var \Drupal\devportal_api_entities\APIDocInterface $revision */
   ...
   * @param \Drupal\devportal_api_entities\APIDocInterface $api_doc
   *   The API Doc entity.
   * @param \Drupal\devportal_api_entities\APIDocStorageInterface $api_doc_storage
