...
use Drupal\devportal_api_entities\APISchemaStorageInterface;
...
class APISchemaController extends ControllerBase {
  ...
  public function revisionPageTitle($api_schema_revision) {
    /** @var \Drupal\devportal_api_entities\Entity\APISchema $api_schema */
    $api_schema = $this->entityTypeManager()->getStorage('api_schema')->loadRevision($api_schema_revision);
   ...
   *
   * @param \Drupal\devportal_api_entities\APISchemaInterface $api_schema
  ...
  public function revisionOverview(APISchemaInterface $api_schema) {
    ...
    /** @var \Drupal\devportal_api_entities\APISchemaStorageInterface $api_schema_storage */
    ...
    foreach ($this->getRevisionIds($api_schema, $api_schema_storage) as $vid) {
      /** @var \Drupal\devportal_api_entities\APISchemaInterface $revision */
   ...
   * @param \Drupal\devportal_api_entities\APISchemaStorageInterface $api_schema_storage
